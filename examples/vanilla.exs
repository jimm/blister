%{inputs: [
  ...
  outputs: [
    # MIDI out -> WaveStation -> Drums
    {"IAC Driver Bus 1", :ws, "WaveStation"},
    {"IAC Driver Bus 1", :drums, "Drums"}
  ],
  messages: [
    ...
    %{name: "Second Song",
      patches: [
        %{name: "Second Song, First Patch",
          connections: [
            %{io: {:mb, :ws, 4}, prog_chg: 22, zone: (76..127)},
            %{io: {:mb, :drums, 6},zone: (64..75),
              filter: fn _conn, bytes -> bytes end} # no-op
          ]}]},
